    ...
    for _, r in tabela.iterrows():
        try:
            ...
            acomp_records.append({
                ...
                'etapa': etapa_calculada,  # USA A ETAPA CALCULADA PELA NOVA FUNÇÃO
                'status': status_calculado,  # USA O STATUS CALCULADO PELA NOVA FUNÇÃO
                'prz_fund': fmt_date(r.get('prz_fundicao')),
                'prz_cont': fmt_date(r.get('prz_contratual')),
