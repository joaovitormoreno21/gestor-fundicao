  ...
  <div class="tab-content" id="tab-materia">
    ...
    <div class="card" style="margin-bottom:10px;">
      ...
      <div class="sim-box">
        ...
        <div class="sim-mini">Adicione uma ou mais ligas com semana e quantidade de metal planejado. A simulação usa a mesma Receita Padrão.</div>
      </div>
      ...
      <div class="twrap" style="margin-bottom:10px;">
        <table>
          <thead><tr><th>Liga</th><th>Semana</th><th style="text-align:right;">Qtd. metal kg</th><th></th></tr></thead>
...
function renderSimulacao(){{
  ...
  </tr>`).join('') || '<tr><td colspan="4" style="color:#888780;">Nenhum item simulado ainda.</td></tr>';
