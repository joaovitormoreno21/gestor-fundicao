...
<div class="container">
  ...
  <div class="tab-content" id="tab-materia">
    ...
    <div class="card" style="margin-bottom:10px;display:flex;gap:10px;align-items:center;justify-content:space-between;flex-wrap:wrap;">
      ...
      <button class="btn" onclick="goSimulacao()" style="background:#185fa5;color:#fff;border-color:#185fa5;">Ir para simulação</button>
    </div>
...
function goSimulacao(){{
  const el=document.getElementById('simulacao-mp');
